...
int main(int argc, char ** argv)
{
	...
	Mat img_diff;
	//std::ostringstream img_file_name;
	...
	std::string results_path = "/mnt/hgfs/SharedFolder_/Results_algorithms/results/baseline";//SET THIS DIRECTORY for storing the results
